...
public class LabDataInfoService implements IService {
    ...
    public JSONObject page(JSONObject data) {
        ...
        CoreBuilder.select()
                ...
                .eq(StringUtils.isNotBlank(data.getString("uploadUserName")), "upload_user_name", data.getString("uploadUserName"))
                .eq(StringUtils.isNotBlank(data.getString("uploadPhone")), "upload_phone", data.getString("uploadPhone"))
