...
@Api(tags = "SysOrganController",description = "系统-机构")
@Slf4j
@RestController
...
public class SysOrganController {
    ...
    public JSONObject tree(@RequestBody SysOrganParam param){
        JSONObject res = sysOrganInfoService.list(new JSONObject());
